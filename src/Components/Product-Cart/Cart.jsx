                                ...
                                <table id="myTable">
                                    ...
                                    <tr>
                                        <td data-label="Product" className="product-name">
                                            ...
                                            <div className="cart-product-img">
                                                <img
                                                    src={require("../../assets/images/menu/burger-07.png")}
                                                    alt="cart-preview"
                                                />
                                            </div>
                                            {/* Description */}
                                            <div className="cart-product-desc">
                                                ...
                                                <p className="p-sm">Magna donec and ipsum gravida</p>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="last-tr">
                                        <td data-label="Product" className="product-name">
                                            ...
                                            <div className="cart-product-img">
                                                <img
                                                    src={require("../../assets/images/menu/pizza-04.png")}
                                                    alt="cart-preview"
                                                />
                                            </div>
                                            {/* Description */}
                    ...
                    Apply Coupon
                        ...
                        <div className="col-lg-4">
                            <div className="cart-checkout bg-lightgrey">
                                ...
                                {/* Button */}
                                <a href="#" className="btn btn-md btn-salmon tra-salmon-hover">
                                    Proceed To Checkout
                                </a>
                            </div>
                        </div>
