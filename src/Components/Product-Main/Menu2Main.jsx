                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/burger-01.png")} alt="menu-image" />
                                            {/* Price */}
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Fried chicken breast, chilli sauce, tomatoes, pickles, coleslaw</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/burger-02.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/burger-06.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/burger-05.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/side-01.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/side-02.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/side-03.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/side-04.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/salad-01.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                                <h5 className="h5-xs yellow-color">$7.99</h5>
                                            </div>
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Tomatoes, cucumbers, olives, feta cheese, red onion, olive oil</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/salad-02.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Chicken breast, chilli sauce, lime juice, lettuce leaves, cucumber</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/salad-03.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Halloumi cheese, spinach, oranges, mint leaves, olive oil</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/salad-04.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                                <h5 className="h5-xs yellow-color">$8.30</h5>
                                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/dessert-01.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Strawberry, soft cheese, icing sugar, butter softened</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/dessert-02.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                                <h5 className="h5-xs yellow-color">$8.50</h5>
                                            </div>
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Berries, Greek yogurt, ice cream, chocolate sauce, peanut butter</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/dessert-03.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                                <h5 className="h5-xs yellow-color">$7.99</h5>
                                            </div>
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Strawberry, double cream, icing sugar, soft cheese, biscuits</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="menu-7-item">
                                        ...
                                        <div className="menu-7-img rel">
                                            {/* Image */}
                                            <img className="img-fluid" src={require("../../assets/images/menu/dessert-04.png")} alt="menu-image" />
                                            {/* Price */}
                                            <div className="menu-7-price bg-coffee">
                                        ...
                                        <div className="menu-7-txt rel">
                                            ...
                                            {/* Description */}
                                            <p className="grey-color">Milk chocolate, icing sugar, cocoa powder, milk, vanilla extract</p>
                                            {/* Button */}
                                            <a href="product-single.html" className="btn btn-sm btn-tra-grey yellow-hover">
                                                <span className="flaticon-shopping-bag" /> Add to Cart
                                            </a>
